...
const MicListener = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`p-6 rounded-lg shadow-lg text-center transition-all ${
          isListening
      ...
      >
        <div className="flex flex-col items-center justify-center mb-4">
          <div className="relative mb-6">
            <AiOutlineAudio
              className={`w-16 h-16 ${
                isListening ? "text-red-500 animate-bounce" : "text-gray-400"
              }`}
            />
            {isListening && (
          ...
          <p className="mt-4 text-sm text-gray-400">
            {isListening
              ? 'Say "emergency emergency" to book ambulance'
              : 'Click the button and say "emergency emergency"'}
          </p>
        </div>
          ...
          <div className="mt-4 p-4 bg-zinc-800 rounded-lg border border-zinc-700">
            ...
            <p
              className={`text-lg font-medium ${
                commandDetected ? "text-green-400" : "text-white"
              }`}
            >
              {transcript}
            </p>
